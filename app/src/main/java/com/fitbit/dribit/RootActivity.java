...
import com.fitbit.dribit.databinding.ActivityRootBinding;
import com.google.common.base.Joiner;

import java.util.Set;

import static com.fitbit.dribit.FitbitAuthApplication.generateAuthenticationConfiguration;
...
public class RootActivity extends AppCompatActivity implements AuthenticationHandler {
    ...
    public void onLoggedIn() {
        Intent intent= new Intent(RootActivity.this,UserDataActivity.class);
